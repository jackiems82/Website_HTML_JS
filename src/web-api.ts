    ...
    [{
        description: { 
            de:{
                ...
                structureText: "Hergestellt im Vakuumverfahren, Birkensperrholz mit Pappelkern und Glasfasern. Ahornfunier bildet wieder den Abschluss. Eine Besonderheit ist das Cleargrip bei einem Deck, wodurch die Oberseite besonders zur Geltung kommt.",
